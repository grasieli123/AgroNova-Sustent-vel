...
```bash
git clone https://github.com/grasieli123/AgroNova-Sustent-vel.git
```

2. Entre na pasta do projeto:

```bash
cd AgroNova-Sustent-vel
```
...
5. Acesse no navegador: `http://localhost:3000` ou `http://127.0.0.1:8000`
